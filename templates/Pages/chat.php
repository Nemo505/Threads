<div class="w-1/2 h-screen mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
    ...
    <div class="p-4" id="chat-messages" style="height: 77%;">
      ...
      <div class="flex mb-4">
        ...
        <div class="ml-3 c py-2 px-3 rounded-md">
      ...
      <div class="flex justify-end mb-4">
        <div class="bg-gradient-to-r from-red-500 to-red-300 py-2 px-3 rounded-md text-white">
    ...
    <!-- Chat Input -->
    <div class="bg-gradient-to-r from-gray-300 via-gray-400 to-gray-300 p-4 flex items-center">
