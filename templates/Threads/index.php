        ...
        <?php foreach ($posts as $post): ?>
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="flex items-center mt-4">
                    <span class="mr-4"><i class="fa-regular fa-thumbs-up"></i> </span>
                    <span  class="mr-4"><i class="fa-regular fa-comment"></i> </span>
                    <span class="mr-4"><i class="fa-solid fa-share"></i> </span>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
