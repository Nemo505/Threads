        ...
        <?php foreach ($posts as $post) : ?>
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="flex items-center mt-4">
                    ...
                    <span class="mr-4 cursor-pointer" data-hs-overlay="#hs-scroll-inside-body-modal" data-comment-title="<?= h($post->title) ?>" data-comment-name="<?= h($post->user->name) ?>" data-comment-content="<?= h($post->body) ?>" onclick="toggleComment(this, <?= $post->id ?>)">
                        <i class="fa-regular fa-comment"></i>
                    </span>
                    <span class="mr-4 cursor-pointer" data-hs-overlay="#share-modal" onclick="toggleShare(this)"><i class="fa-solid fa-share"></i></span>
                </div>
...
<!-- share confirm box -->
<div id="share-modal" class="hs-overlay hidden w-full h-full 
           fixed top-[40%] start-0 z-[60] 
        ...
        <div class="max-h-full overflow-hidden 
            ...
            <div class="flex justify-between items-center 
                ...
                <button type="button" class="flex justify-center 
                       ...
                       dark:focus:ring-1 
                       dark:focus:ring-gray-600" data-hs-overlay="#share-modal">
                    <span class="sr-only">Close</span>
                    <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M18 6 6 18" />
                        <path d="m6 6 12 12" />
            ...
            <div class="p-4 overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <div class=" flex justify-between items-center">
                        ...
                        <?= $this->Form->button('Confirm', ['class' => 'bg-green-500 hover:bg-green-700 text-white font-bold mt-2 px-4 rounded ']) ?>
                    </div>
                        ...
                        var commentHtml = `
                            <div class="bg-dark-100 text-white py-4 px-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    <span class="cursor-pointer" onclick="toggleLike(this, ${comment.id})">
